          ...
          <div className="flex items-center gap-4">
            ...
            {user ? (
              <div className="relative group">
                ...
                <div className="absolute right-0 w-48 bg-white rounded-lg shadow-lg py-2 hidden group-hover:block">
                  <button
                    onClick={handleUserClick}
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden py-4 border-t">
            <nav className="flex flex-col gap-4">
              <Link to={ROUTES.HOME} className="hover:text-blue-600 transition" onClick={() => setIsMobileMenuOpen(false)}>
                {t('header.home')}
              </Link>
              <Link to={ROUTES.CATALOG} className="hover:text-blue-600 transition" onClick={() => setIsMobileMenuOpen(false)}>
                {t('header.catalog')}
              </Link>
              <Link to="#" className="hover:text-blue-600 transition" onClick={() => setIsMobileMenuOpen(false)}>
                {t('header.about')}
              </Link>
              <Link to="#" className="hover:text-blue-600 transition" onClick={() => setIsMobileMenuOpen(false)}>
                {t('header.support')}
